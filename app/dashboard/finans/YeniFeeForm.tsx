        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
          ...
          <div className="w-full max-w-md rounded-2xl p-6"
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div>
                <label className="block text-[12px] font-medium mb-1" style={{ color: "var(--text-2)" }}>Müşteri</label>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[12px] font-medium mb-1" style={{ color: "var(--text-2)" }}>Tutar (TL)</label>
                ...
                <div>
                  <label className="block text-[12px] font-medium mb-1" style={{ color: "var(--text-2)" }}>Son Ödeme Tarihi</label>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[12px] font-medium mb-1" style={{ color: "var(--text-2)" }}>Ay</label>
                ...
                <div>
                  <label className="block text-[12px] font-medium mb-1" style={{ color: "var(--text-2)" }}>Yıl</label>
              ...
              <div>
                <label className="block text-[12px] font-medium mb-1" style={{ color: "var(--text-2)" }}>Not (opsiyonel)</label>
